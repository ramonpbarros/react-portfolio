...
function About() {
  return (
    <div className="col-lg-7 col-m-9 indexContainer animation textPosition">
      ...
      <p className="paddingLeftHome" style={{ color: "white", fontSize: 20 }}>
        I've been living in San Diego for the past 12 years and during this time
        I had some experience working with mobile development, but mostly
      ...
      <p className="paddingLeftHome" style={{ color: "white", fontSize: 20 }}>
        ...
        groups. With each project, my goal is to best engage my audience for an
